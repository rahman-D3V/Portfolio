...
export function AnimatedShinyButton({ children, className = "", url }) {
  return (
    <>
      <style jsx>{`
        ...
        .shiny-cta-link {
          ...
          --shiny-cta-fg: #ffffff;
          --shiny-cta-highlight: #f87171;
          --shiny-cta-highlight-subtle: #dc2626;
        ...
        @media (prefers-color-scheme: light) {
          ...
          .shiny-cta-link {
            ...
            --shiny-cta-highlight-subtle: #b91c1c;
          }
        }
      `}</style>
